...
$result = mysqli_query($mysqli, "SELECT * FROM `addata` WHERE target = 'sada' ORDER BY category ASC, id DESC"); // using mysqli_query instead
...
<body style="background-image: url('photos/sada-bg.jpg'); background-repeat: no-repeat; background-position: center center;background-size: cover; background-attachment: fixed; ">
<nav class="navbar navbar-inverse sada-color navbar-fixed-top">
     ...
     <ul class="nav navbar-nav navbar-right">
                ...
                <!-- LOG IN -->
                  <div id="Div1">
                    ...
                    <div style="padding:20px;" >
                      <form id="sign_in" class="form-horizontal" action="sada.php" role="form" method="POST" >
                  ...
                  <div id="Div2" style="display: none">
                    ...
                    <div style="padding: 9px 25px;">
                      <form id="loginform" class="form-horizontal" action="sada.php" role="form" method="POST">
                        <input type="hidden" name="_token" value="vRBAgZmSlHWdJYHGtrZrtuJ9JaaVNjKSv0HRTthm">
		  ...
		  ';}
			...
			<li class="dropdown">
				...
				<ul class="dropdown-menu login-panel">
					<li>
						<form action="sada.php" class="form-horizontal" role="form" style="margin-top:5px;" method="POST">
...
?>
        ...
        $counter = 0;
        echo "<div class=\"sada-result-card\">";
        while( $res = mysqli_fetch_array($result)){

            echo "<a href = \"result.php?id=".$res['id']."\"> <div class=\"sada-result-card-2 ".$res['category']."\">
            <div class=\"sada-result-card-2-image\">
              <img src=\"".$res['picture']."\"> 
            </div>
            <div class=\"sada-result-card-2-content\">
        ...
        while($res = mysqli_fetch_array($result)){
          ...
          echo "<a href = \"result.php?id=".$res['id']."\"> <div class=\"sada-result-card ".$res['category']."\">
          <div class=\"sada-result-image\">
            <img src=\"".$res['picture']."\">
          </div>
            <h4>".$res['title']."</h4>
            <h5><span class=\"glyphicon glyphicon-phone\"></span>  ".$res['phone']."</h5>
