...
$result = mysqli_query($mysqli, "SELECT * FROM `addata` WHERE target = 'seecs' ORDER BY category ASC, id DESC"); // using mysqli_query instead
...
<body style="background-image: url('photos/chip.jpg'); background-repeat: no-repeat; background-position: center center;background-size: cover; background-attachment: fixed; ">
<nav class="navbar navbar-inverse seecs-color navbar-fixed-top">
     ...
     <ul class="nav navbar-nav navbar-right">
                ...
                <!-- LOG IN -->
                  <div id="Div1">
                    ...
                    <div style="padding:20px;" >
                      <form id="sign_in" class="form-horizontal" action="seecs.php" role="form" method="POST" >
                  ...
                  <div id="Div2" style="display: none">
                    ...
                    <div style="padding: 9px 25px;">
                      <form id="loginform" class="form-horizontal" action="seecs.php" role="form" method="POST">
                        <input type="hidden" name="_token" value="vRBAgZmSlHWdJYHGtrZrtuJ9JaaVNjKSv0HRTthm">
		  ...
		  ';}
			...
			<li class="dropdown">
				...
				<ul class="dropdown-menu login-panel">
					<li>
						<form action="seecs.php" class="form-horizontal" role="form" style="margin-top:5px;" method="POST">
...
?>
          ...
          while($res = mysqli_fetch_array($result)){
            ...
            echo "<a href = \"result.php?id=".$res['id']."\"> <div class=\"seecs-result-card ".$res['category']."\">
                    <div class=\"seecs-result-image\">
                      <img src = \"".($res['picture'])."\">
                    </div>
                    <div class=\"seecs-result-content\">
