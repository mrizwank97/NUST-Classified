...
<body style="background-image:url('photos/p12.jpg');background-repeat: no-repeat; background-position: center center;background-size: cover; background-attachment: fixed;">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="mainNavBar">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="hostel.php" style="color: #FFFFFF">Hostels</a></li>
...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <div class="col-sm-8 text-left">
		...
		<div class="row">
		<a href="hostel-ads.php"><div class="card col-sm-3" >
			<div class ="school">
				<img src="photos/hostel-ads.jpg">
			</div>
			<p class="h4" >View Ads</p>
		</div></a>
		<a href="roomswap.php"><div class="card col-sm-3" >
			<div class ="school">
				<img src="photos/hostel-room.jpg">
			</div>
			<p class="h4">Room Swap</p>
		</div></a>
		<a href="hostelstay.php"><div class="card col-sm-3" >
			<div class ="school"> 
				<img src="photos/hostel-room.jpg">
			</div>
			<p class="h4">Hostel Stay</p>
		</div></a>
		<a href="roomcooler.php"><div class="card col-sm-3" >
			<div class ="school">
				<img src="photos/hostel-coolers.jpg">
			</div>
			<p class="h4">Air Coolers</p>
		</div></a>
		<a href="refrigerator.php"><div class="card col-sm-3" >
			<div class ="school">
				<img src="photos/hostel-refrigerator.jpg">
			</div>
			<p class="h4">Refrigerators</p>
		</div></a>
		<a href="electronics.php"><div class="card col-sm-3" >
			<div class ="school">
				<img src="photos/hostel-electronics.jpg">
			</div>
			<p class="h4">Electronics</p>
		</div></a>
		<a href="other.php"><div class="card col-sm-3" >
			<div class ="school">
				<img src="photos/hostel-products.jpg">
			</div>
