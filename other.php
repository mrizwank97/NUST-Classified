...
$result = mysqli_query($mysqli, "SELECT * FROM addata WHERE category = 'other' ORDER BY id DESC"); // using mysqli_query instead
?>
<html lang="en">
<head>
...
<body style="background-image:url('photos/p8.jpg');background-repeat: no-repeat; background-position: center center;background-size: cover; background-attachment: fixed;">
     ...
     <ul class="nav navbar-nav navbar-right">
                ...
                <!-- LOG IN -->
                  <div id="Div1">
                    ...
                    <div style="padding:20px;" >
                      <form id="sign_in" class="form-horizontal" action="other.php" role="form" method="POST" >
                  ...
                  <div id="Div2" style="display: none">
                    ...
                    <div style="padding: 9px 25px;">
                      <form id="loginform" class="form-horizontal" action="other.php" role="form" method="POST">
                        <input type="hidden" name="_token" value="vRBAgZmSlHWdJYHGtrZrtuJ9JaaVNjKSv0HRTthm">
		  ...
		  ';}
			...
			<li class="dropdown">
				...
				<ul class="dropdown-menu login-panel">
					<li>
						<form action="other.php" class="form-horizontal" role="form" style="margin-top:5px;" method="POST">
