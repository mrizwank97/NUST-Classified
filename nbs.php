...
$result = mysqli_query($mysqli, "SELECT * FROM `addata` WHERE target = 'nbs' ORDER BY category ASC, id DESC"); // using mysqli_query instead
...
<body style="background-image: url('photos/nbs-bg.jpg'); background-repeat: no-repeat; background-position: center center;background-size: cover; background-attachment: fixed; ">
     ...
     <ul class="nav navbar-nav navbar-right">
                ...
                <!-- LOG IN -->
                  <div id="Div1">
                    ...
                    <div style="padding:20px;" >
                      <form id="sign_in" class="form-horizontal" action="nbs.php" role="form" method="POST" >
                  ...
                  <div id="Div2" style="display: none">
                    ...
                    <div style="padding: 9px 25px;">
                      <form id="loginform" class="form-horizontal" action="nbs.php" role="form" method="POST">
                        <input type="hidden" name="_token" value="vRBAgZmSlHWdJYHGtrZrtuJ9JaaVNjKSv0HRTthm">
		  ...
		  ';}
			...
			<li class="dropdown">
				...
				<ul class="dropdown-menu login-panel">
					<li>
						<form action="nbs.php" class="form-horizontal" role="form" style="margin-top:5px;" method="POST">
...
<div class="container-fluid text-center" >   
  ...
  <a class="right carousel-control" href="#myCarousel" data-slide="next">
    ...
    <span class="sr-only">Next</span>
     ...
     <div class="col-sm-2 sidenav" style="background: rgba(59,59,59, 0.6); height: 100%">
  	<div class="well nbs-color">
        <p>News</p>
      </div>
      <div class="well nbs-color">
        <p>News</p>
