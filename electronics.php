...
$result = mysqli_query($mysqli, "SELECT * FROM addata WHERE category = 'electronics' ORDER BY id DESC"); // using mysqli_query instead
?>
<html lang="en">
<head>
...
<body style="background-image:url('photos/p4.jpg');background-repeat: no-repeat; background-position: center center;background-size: cover; background-attachment: fixed;">
<nav class="navbar navbar-inverse" style="background:#00688b;">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a href="home.html" class ="navbar-brand" style="color:white"> NUST Classified </a>
            </div>
            <!-- Menu Items -->
            <div class="collapse navbar-collapse" id="mainNavBar">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="hostel.php" style="color: white">Hostels</a></li>
					<li><a href="#" style="color: white">Socities</a></li>
     ...
     <ul class="nav navbar-nav navbar-right">
                ...
                <!-- LOG IN -->
                  <div id="Div1">
                    ...
                    <div style="padding:20px;" >
                      <form id="sign_in" class="form-horizontal" action="electronics.php" role="form" method="POST" >
                  ...
                  <div id="Div2" style="display: none">
                    ...
                    <div style="padding: 9px 25px;">
                      <form id="loginform" class="form-horizontal" action="electronics.php" role="form" method="POST">
                        <input type="hidden" name="_token" value="vRBAgZmSlHWdJYHGtrZrtuJ9JaaVNjKSv0HRTthm">
		  ...
		  ';}
			...
			<li class="dropdown">
				...
				<ul class="dropdown-menu login-panel">
					<li>
						<form action="electronics.php" class="form-horizontal" role="form" style="margin-top:5px;" method="POST">
...
?>
			...
			while($res = mysqli_fetch_array($result)) { 		
				echo "<a href=\"result.php?id=$res[id]\"><div class='flip-container'><div class='flip-card'><div class='front'><img src=".$res['picture']."></div>";
				echo "<div class='back'><h4>".$res['title']."</h4>";
				echo "<p>".$res['content']."</p>";
				echo "<h5><span class='glyphicon glyphicon-phone'>&nbsp;".$res['phone']."</h5>";
				echo "<h5><span class='glyphicon glyphicon-usd'>&nbsp;Rs.".$res['price']."/-</h5></div></div></div></a>";
			}
			$mysqli->close();
	        ?>
			</div>
...
<footer class="container-fluid text-center">
  <div class="row">
  	<div class="col-sm-2">
    	<h6>Copyright &copy; 2018 NUST Classified</h6>
    </div>
  	<div class="col-sm-4">
    	<h6>About us</h6>
    ...
    <div class="col-sm-2">
    	<h6>Coded with &nbsp;<span class="glyphicon glyphicon-heart"><span> by Team</h6>
    </div>
  </div>
</footer>
