...
$result = mysqli_query($mysqli, "SELECT * FROM addata WHERE category = 'hostelstay' ORDER BY id DESC"); // using mysqli_query instead
?>
<html lang="en">
<head>
...
<body style="background-image:url('photos/p13.jpg');background-repeat: no-repeat; background-position: center center;background-size: cover; background-attachment: fixed;">
         ...
         <?php
                ...
                <!-- LOG IN -->
                  <div id="Div1">
                    ...
                    <div style="padding:20px;" >
                      <form id="sign_in" class="form-horizontal" action="hostelstay.php" role="form" method="POST" >
                  ...
                  <div id="Div2" style="display: none">
                    ...
                    <div style="padding: 9px 25px;">
                      <form id="loginform" class="form-horizontal" action="hostelstay.php" role="form" method="POST">
                        <input type="hidden" name="_token" value="vRBAgZmSlHWdJYHGtrZrtuJ9JaaVNjKSv0HRTthm">
		  ...
		  ';}
			...
			<li class="dropdown">
				...
				<ul class="dropdown-menu login-panel">
					<li>
						<form action="hostelstay.php" class="form-horizontal" role="form" style="margin-top:5px;" method="POST">
...
?>
			...
			while($res = mysqli_fetch_array($result)) { 		
				echo "<a href=\"result.php?id=$res[id]\"><div class='result-card'><div class='result-image'><img src=".$res['picture']."></div>";
