...
<body style="background-image:url('photos/p5.jpg');background-repeat:no-repeat;background-size:cover;">
<nav class="navbar navbar-inverse" style="background:#00688b">
     ...
     <ul id = "hide" class="nav navbar-nav navbar-right">
...
<div class="container-fluid text-center">    
  ...
  <div class="carousel-inner">
    <div class="item">
      <img  src="photos/1.jpg" alt="NUST">
    </div>

    <div class="item active">
      <img src="photos/2.jpg" alt="NUST Main Office">
    </div>

    <div class="item">
      <img src="photos/3.jpg" alt="NUST-SEECS">
    </div>
  </div>
