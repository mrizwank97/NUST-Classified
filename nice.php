...
$result = mysqli_query($mysqli, "SELECT * FROM `addata` WHERE target = 'nice' ORDER BY category ASC, id DESC"); // using mysqli_query instead
...
<body  style="background-image: url('photos/nice-bg.jpg'); background-repeat: no-repeat; background-position: center center;background-size: cover; background-attachment: fixed; ">
<nav class="navbar navbar-inverse nice-color navbar-fixed-top">
     ...
     <ul class="nav navbar-nav navbar-right">
                ...
                <!-- LOG IN -->
                  <div id="Div1">
                    ...
                    <div style="padding:20px;" >
                      <form id="sign_in" class="form-horizontal" action="nice.php" role="form" method="POST" >
                  ...
                  <div id="Div2" style="display: none">
                    ...
                    <div style="padding: 9px 25px;">
                      <form id="loginform" class="form-horizontal" action="nice.php" role="form" method="POST">
                        <input type="hidden" name="_token" value="vRBAgZmSlHWdJYHGtrZrtuJ9JaaVNjKSv0HRTthm">
		  ...
		  ';}
			...
			<li class="dropdown">
				...
				<ul class="dropdown-menu login-panel">
					<li>
						<form action="nice.php" class="form-horizontal" role="form" style="margin-top:5px;" method="POST">
...
?>
  ...
  repeat:
        $counter = 0;
        $flag = true;
        echo "<div class=\"nice-result-card\">";
        while( $res = mysqli_fetch_array($result)){

            echo "<a href = \"result.php?id=".$res['id']."\"> <div class=\"nice-result-card-2 ".$res['category']."\">
            <div class=\"nice-result-card-2-image\">
              <img src=\"".$res['picture']."\"> 
            </div>
            <div class=\"nice-result-card-2-content\">
